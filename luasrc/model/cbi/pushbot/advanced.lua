...
s = m:section(TypedSection, "pushbot", translate("Advanced Settings"))
s.anonymous = true
s.addremove = false
...
a=s:option(Value, "soc_code", translate("Custom Temperature Command"))
a.rmempty = true 
...
a= s:option(Value, "autoreboot_time", translate("System Uptime Greater Than"))
a.rmempty = true 
a.default = "24"
a.datatype="uinteger"
...
a=s:option(Value, "network_restart_time", translate("Network Uptime Greater Than"))
a.rmempty = true 
a.default = "24"
a.datatype="uinteger"
...
a= s:option(Value, "public_ip_retry_count", translate("Max Daily Retries"))
a.rmempty = true 
a.default = "10"
a.datatype="uinteger"
